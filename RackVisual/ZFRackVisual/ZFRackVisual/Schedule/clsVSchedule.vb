...
#Region "Load"
    ...
    Private Sub clsVSchedule_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        clsVMain.ToolStripStatusLabel.Text = "Status"
    End Sub
    Private Sub clsVSchedule_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Dim c As New clsPSchedule
        'For i As Integer = 1377 To 2100
        '    MsgBox(c.GetExcelCol(i))
        'Next
    ...
    Private Sub btnChart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChart.Click
        ...
        If CalValidate() = True Then
            ...
            'CType(Me.ParentForm, clsVMain).StatusStrip.Text = "Last Calculated " & Now
            clsVMain.ToolStripStatusLabel.Text = "Last Calculated " & Now
        End If
    End Sub
    ...
    Private Sub txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCapacityZF.TextChanged, txtCapacityCus.TextChanged _
                                            , txtIniEmptyRackCus.TextChanged, txtIniEmptyRackZF.TextChanged, txtInitialFGCus.TextChanged, txtInitialFGZF.TextChanged
        CalHeader()
    End Sub
    ...
    Private Sub CalHeader()
        ...
        txtTotalRack.Text = Converts.ToInt_NullIsZero(txtIniEmptyRackZF.Text.Trim) _
                            + Converts.ToInt_NullIsZero(txtInitialFGZF.Text.Trim) _
                            + Converts.ToInt_NullIsZero(txtIniEmptyRackCus.Text.Trim) _
                            + Converts.ToInt_NullIsZero(txtInitialFGCus.Text.Trim) _
                            + Converts.ToInt_NullIsZero(txtBlockForSkiplot.Text.Trim) _
                            + Converts.ToInt_NullIsZero(txtBlockForMaintenance.Text.Trim)
...
NextLoop2:
    ...
    Private Sub CalculateDTDay(ByVal iDay As Integer, ByVal IniEmptyRackZF As Integer, ByVal InitialFGZF As Integer, ByVal InitialFGCus As Integer, ByVal IniEmptyRackCus As Integer)
        ...
        dtZFEmptyRack(iDay) = cls.GetRemain(dtZFEmptyRack(iDay) _
                                            , IniEmptyRackZF, clsCSchedule.eGridType.ZFEmptyRack _
                                            , IIf(iDay = 0, Converts.ToInt_NullIsZero(txtBlockForSkiplot.Text.Trim), 0) _
                                            , IIf(iDay = 0, Converts.ToInt_NullIsZero(txtBlockForMaintenance.Text.Trim), 0) _
                                            )
...
#Region "Print"
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As OPE_Controls.EventArgs) Handles btnPrint.Click
        ...
        If OK = True Then
            ...
            ElseIf frm.rdoAllPageExcel.Checked Then
                iPrintType = clsPSchedule.ePrintType.AllPageExcel
            ElseIf frm.rdoZFEmptyRack.Checked Then
                iPrintType = clsPSchedule.ePrintType.ZFEmpty
            ElseIf frm.rdoZFFG.Checked Then
                iPrintType = clsPSchedule.ePrintType.ZFFG
            ElseIf frm.rdoCusFG.Checked Then
                iPrintType = clsPSchedule.ePrintType.CustomerFG
            Else
                iPrintType = clsPSchedule.ePrintType.CustomerEmtpyReturn
            End If
        End If
        frm = Nothing
