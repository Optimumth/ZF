...
Public Class clsCRackStatus
    Public Function GetData(fType As Boolean, Type As Integer _
        ...
        Dim sql As String = String.Format( _
            "select '1900-01-01' as ScanDateTime,Model,Code,RackNo,'ZF' as RackStatus,ColorA,ColorR,ColorG,ColorB,mRackDT.ID as RackDTID,RackID,Remark,Type,LossFlag {0}" & _
