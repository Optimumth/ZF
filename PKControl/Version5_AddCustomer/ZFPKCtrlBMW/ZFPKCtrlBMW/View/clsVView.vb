...
#Region "Program Active"
    ...
    '    End If
    'End Sub
    Private Sub clsVView_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, btnExit.KeyUp, btnDeleteRack.KeyUp, btnDeleteTruck.KeyUp, btnSortA.KeyUp, btnSortD.KeyUp, grdData.KeyUp, txtRackQty.KeyUp
