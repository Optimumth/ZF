...
#End Region
    ...
    Private Sub ShowStatus()
        If dtStatus Is Nothing OrElse dtStatus.Rows.Count = 0 Then
            ...
            txtSTB.Text = "" : txtMBikeFront.Text = "" : txtMBikeRear.Text = ""
            Exit Sub
        End If
        ...
        For iTypeLoop As Integer = 1 To 6
            ...
            Select Case iType
                ...
                Case Else : grdShow = grdMBikeRear
            End Select
    ...
    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As OPE_Controls.EventArgs) Handles btnSearch.Click
        ...
        If grdFront.RowCount > 0 Or grdFront.RowCount + grdRear.RowCount + grdFrontRear.RowCount + grdSTB.RowCount + grdMBikeFront.RowCount + grdMBikeRear.RowCount = 0 Then
