...
ByVal lpParameters As String, ByVal lpDirectory As String, ByVal nShowCmd As Integer) As Integer
    ...
    Public Function Print(ByVal drTruck As DataRow, ByVal dtData As DataTable) As Boolean
        ...
        Dim ExcelRowTotal As Integer = 20
        Dim ExcelRowSummary As Integer = 21
        ...
        With cPrint
            ...
            dtModelContainer.Columns.Add("MBikeFrontQty", GetType(Integer))
            dtModelContainer.Columns.Add("MBikeRearQty", GetType(Integer))
            ...
            For Each drData As DataRow In dtData.Select("", "ModelContainer,ModelContainerSeq")
                If sGroup <> drData("ModelContainer") Then
                    ...
                    drAddGroup("STBQty") = 0
                    drAddGroup("MBikeFrontQty") = 0
                    drAddGroup("MBikeRearQty") = 0
            ...
            For Each dr As DataRow In dtModelContainer.Select("", "ModelContainerSeq,ModelContainer")
                ...
                dr("MBikeFrontQty") = dtData.Compute("count(Rack)", "ModelContainer='" & dr("ModelContainer") & "' and Type=" & SystemINI.ModelTypeBMW.MBikeFront & "")
                dr("MBikeRearQty") = dtData.Compute("count(Rack)", "ModelContainer='" & dr("ModelContainer") & "' and Type=" & SystemINI.ModelTypeBMW.MBikeRear & "")
            Next
            ...
            For iSheet As Integer = AllPage To 1 Step -1
                ...
                .setSheatHeader("J35", Converts.ToStr(drTruck("DriverName")))
                .setSheatHeader("AB35", Converts.ToStr(drTruck("Tel")))
                .setSheatHeader("J36", Converts.ToStr(drTruck("ZFInCharge")))
                .setSheatHeader("J37", Converts.ToStr(drTruck("CusInCharge")))
                ...
                Dim MBikeQty As Integer = dtData.Compute("count(Rack)", "Type=" & SystemINI.ModelTypeBMW.MBikeFront & " or Type=" & SystemINI.ModelTypeBMW.MBikeRear & "")
                ...
                For Each drGroup As DataRow In dtModelContainer.Select("", "ModelContainerSeq,ModelContainer")
                    ...
                    If Converts.ToInt_NullIsZero(drGroup("MBikeFrontQty")) > 0 Then .setSheatHeader(sGroupCol & ExcelRowSummary + 5, drGroup("MBikeFrontQty"))
                    If Converts.ToInt_NullIsZero(drGroup("MBikeRearQty")) > 0 Then .setSheatHeader(sGroupCol & ExcelRowSummary + 6, drGroup("MBikeRearQty"))
