        ...
        With cboModel
            ...
            Else
                Select Case cboType.SelectedRow("ID")
                    ...
                    Case SystemINI.ModelTypeBMW.MBikeFront : .DataSource = DataBase.DataSelect("MstModel", "DelFlag=0 and MBikeFrontFlag=1")
                    Case SystemINI.ModelTypeBMW.MBikeRear : .DataSource = DataBase.DataSelect("MstModel", "DelFlag=0 and MBikeRearFlag=1")
                    Case SystemINI.ModelTypeBMW.PTC
                        '.DataSource = DataBase.DataSelect("MstModel", "DelFlag=0 and PTCFlag=1")
                        .DataSource = DataBase.DataSelect("MstModel" _
