...
ByVal lpParameters As String, ByVal lpDirectory As String, ByVal nShowCmd As Integer) As Integer
    ...
    Public Function Print(ByVal drTruck As DataRow, ByVal dtData As DataTable) As Boolean
        ...
        With cPrint
            ...
            For Each dr As DataRow In dtModelContainer.Select("", "ModelContainerSeq,ModelContainer")
                dr("FrontQty") = dtData.Compute("count(Rack)", "ModelContainer='" & dr("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.Front & "")
                dr("RearQty") = dtData.Compute("count(Rack)", "ModelContainer='" & dr("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.Rear & "")
                dr("BPSQty") = dtData.Compute("count(Rack)", "ModelContainer='" & dr("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.BPS & "")
            Next
            ...
            For iSheet As Integer = AllPage To 1 Step -1
                ...
                Dim RackQty As Integer = dtData.Compute("count(Rack)", "Type=" & SystemINI.ModelTypeMB.Front & " or Type=" & SystemINI.ModelTypeMB.Rear & "")
                Dim BPSQty As Integer = dtData.Compute("count(Rack)", "Type=" & SystemINI.ModelTypeMB.BPS & "")
    ...
    Public Function Print_BK(ByVal drTruck As DataRow, ByVal dtData As DataTable) As Boolean
        ...
        With cPrint
            ...
            For Each drGroup As DataRow In dtModelContainer.Select("", "ModelContainerSeq")
                ...
                Dim sGroupCol As String = GetSummaryCol(iGroup)
                Dim iFrontQty As Integer = dtData.Compute("count(Rack)", "ModelContainer='" & drGroup("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.Front & "")
                Dim iRearQty As Integer = dtData.Compute("count(Rack)", "ModelContainer='" & drGroup("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.Rear & "")
                Dim iBPSQty As Integer = dtData.Compute("count(Rack)", "ModelContainer='" & drGroup("ModelContainer") & "' and Type=" & SystemINI.ModelTypeMB.BPS & "")
                .setSheatHeader(sGroupCol & ExcelRowSummary, Converts.ToStr(drGroup("ModelContainer")))
