            ...
            Select Case CustomerCode
                ...
                Case "BMW"
                    Select Case iType
                        ...
                        Case SystemINI.ModelTypeBMW.MBike : Converts.ToStringSQLCond(cond, "MBikeFlag=1")
                        Case SystemINI.ModelTypeBMW.PTC : Converts.ToStringSQLCond(cond, "PTCFlag=1")
                    End Select
            End Select
        End If
    ...
    Public Function SaveData(dt As DataTable) As Boolean
        Try
            ...
            For Each dr As DataRow In dt.Select("sta<>''")
                Select Case dr("sta")
                    Case "N"
                        Dim dtDeleted As DataTable = DataBase.DataSelect("MstModel", "DelFlag=1 and Model='" & dr("Model") & "' and ModelContainer='" & dr("ModelContainer") & "'")
