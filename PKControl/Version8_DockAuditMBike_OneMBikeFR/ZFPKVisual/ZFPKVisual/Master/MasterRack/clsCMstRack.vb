...
Public Class clsCMstRack
    Public Function GetData(chkSType As Boolean, iType As Integer _
        ...
        Else
            ...
            Dim iMBike As Integer = SystemINI.ModelTypeBMW.MBike
            ...
            dt = DataBase.DataSelect("MstRackHD" _
                                                      ...
                                                      , , , "MstRackHD.*" & _
                                                            ...
                                                            "      when Type = " & iMBike & " then '" & INI.sMBike & "'" & _
    ...
    Public Function SaveData(dt As DataTable) As DataTable
        ...
        Try
            ...
            For Each dr As DataRow In dt.Select("sta<>''")
                Select Case dr("sta")
                    Case "N" 'Rack HD จะไม่นำเรคคอร์ดที่ Delete ไปแล้ว กลับมา รียูส เพราะต้องการให้สร้าง Rack DT ใหม่
                        RackHeaderID += 1
