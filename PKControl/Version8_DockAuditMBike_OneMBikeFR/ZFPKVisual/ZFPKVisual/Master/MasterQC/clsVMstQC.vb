...
#Region "Load"
    ...
    Private Sub LoadForm()
        ...
        Dim iMTBOnly As Integer = clsCMstQC.eMTBSelection.MTBOnly
        Dim iNotMTB As Integer = clsCMstQC.eMTBSelection.NotMTB
        With cboSMTB
            .ValueMember = "MTBID"
            .DisplayMember = "MTBText"
            .DataSource = DataBase.DataTable("select " & iMTBOnly & " as MTBID,'MTB Only' as MTBText union select " & iNotMTB & " as MTBID, 'Not MTB' as MTBText")
            .LinkCheckedBox = chkSMTB
        End With

        Dim dt As DataTable = cls.GetData(True, -1, False, 0, False, 0)
        Dim dv As DataView
...
#Region " Data Grid "
    Private Sub grdData_BindingGridColumns() Handles grdData.BindingGridColumns
        With grdData
            ...
            .ColumnAdd_CheckBox("MBikeFlag", "MTB", "MBikeFlag")
        End With
    End Sub
...
#Region "Toolbar Click"
    Private Sub btnSearch_Click(sender As Object, e As OPE_Controls.EventArgs) Handles btnSearch.Click
        ...
        Dim iMTBSelection As Integer = 0
        If chkSMTB.Checked Then
            iMTBSelection = cboSMTB.SelectedRow("MTBID")
        End If

        Dim dt As DataTable = cls.GetData(chkSCheckNo.Checked, sCheckNo, chkSFront.Checked, chkSRear.Checked, chkSMTB.Checked, iMTBSelection)
    ...
    Private Sub DisplayUpdate(rGrid As DataRow, RowIndex As Integer)
        ...
        chkMTB.Checked = rGrid("MBikeFlag")
...
#Region "Data to Grid"
    ...
    Private Sub DataToGrid()
        ...
        drAdd("MBikeFlag") = IIf(chkMTB.Checked = True, 1, 0)
