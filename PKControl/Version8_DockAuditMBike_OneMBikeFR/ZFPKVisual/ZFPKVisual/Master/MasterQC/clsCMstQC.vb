...
Public Class clsCMstQC
    Public Enum eMTBSelection
        MTBOnly = 1
        NotMTB = 2
    End Enum

    Public Function GetData(chkSCheckNo As Boolean, sCheckNo As String _
                            , chkSFront As Boolean, chkSRear As Boolean _
                            , chkSMTB As Boolean, iMTBSelection As Integer) As DataTable
        ...
        End If
        If chkSMTB = True Then
            Select Case iMTBSelection
                Case eMTBSelection.MTBOnly : cond &= String.Format(" and MBikeFlag=1 {0}", vbCrLf)
                Case eMTBSelection.NotMTB : cond &= String.Format(" and MBikeFlag=0 {0}", vbCrLf)
            End Select
        End If
