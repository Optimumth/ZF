...
Public Class clsCMstPart
    Public Function GetData(chkVariant As Boolean, sVariant As String _
                            ...
                            , chkSCaliper As Boolean, iCaliperFlag As Integer _
                            , chkSActiveFlag As Boolean) As DataTable
        ...
        If chkSActiveFlag = True Then Converts.ToStringSQLCond(cond, "ActiveFlag=1")
        ...
        Dim dt As DataTable = DataBase.DataSelect("MstPart" _
                                                  ...
                                                  , , , "MstPart.*" & _
                                                        ...
                                                        ",MstModelDock.ModelDock" & _
                                                        ",'' as sta" _
                                                  , , " inner join CstArea on MstPart.AreaID=CstArea.ID" & _
                                                      " inner join CstPartType on MstPart.PartTypeID=CstPartType.ID" & _
                                                      " left join MstModelDock on MstPart.ModelDockID=MstModelDock.ID")
