...
#Region "Summary"
    Private Sub Summary()
        ...
        txtPTCAmount.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelTypeBMW.PTC & " and sta<>'D'")
        ...
        txtMBike.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelTypeBMW.MBike & " and sta<>'D'")
    End Sub
#End Region
