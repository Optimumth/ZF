...
Public Class clsVTruckDT
    Private cls As New clsCTruckDT
...
#Region "Toolbar Click"
    ...
    Private Sub btnNew_Click(ByVal sender As Object, ByVal e As OPE_Controls.EventArgs) Handles btnNew.Click
        Dim frm As New clsVTruckDT_NewTrans
        Dim dv As DataView = grdData.DataSource
...
#Region "Summary"
    Private Sub Summary()
        ...
        txtFront.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelTypeMB.Front & " and sta<>'D'")
        txtRear.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelTypeMB.Rear & " and sta<>'D'")
        txtBPS.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelTypeMB.BPS & " and sta<>'D'")
    End Sub
#End Region
