...
#Region "Program Active"
    Private Sub clsVConfig_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, txtAutoLogout.KeyUp, btnSave.KeyUp, btnExit.KeyUp
...
#Region "Call Function"
    Private Sub SaveClick()
        If SaveValidate() = True Then
            ...
            sql &= "set AutoLogoutMin = " & Convert.ToInt16(txtAutoLogout.Text.Trim) & ""
    ...
    Private Function SaveValidate() As Boolean
        If Not IsNumeric(txtAutoLogout.Text.Trim) Then
