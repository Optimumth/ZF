...
Public Class clsVScanDockAudit
    ...
    Private Sub HandleData(ByVal TheReaderData As Symbol.Barcode.ReaderData)
        ...
        Select Case QRIndex
            ...
            Case eQR.Varian : txtItem.Text = strData(2)
    ...
    Private Sub clsVDockAudit_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    End Sub
    Private Sub clsVDockAudit_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, btnExit.KeyUp, btnSave.KeyUp _
          , txtModel.KeyUp, txtItem.KeyUp, txtLot.KeyUp, txtDeliveryNoteNo.KeyUp, txtAxleNo.KeyUp
    ...
    Private Sub clsVDockAudit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Click, btnExit.Click, btnSave.Click
        clsCLogin.ActiveDateTime = Now
        MoveActiveDateTime = Now
    ...
    Private Sub SaveData()
        If cls.SaveData(TruckID, txtModel.Text.Trim, txtItem.Text.Trim, txtLot.Text.Trim, txtDeliveryNoteNo.Text.Trim, txtAxleNo.Text.Trim) = False Then
            PlayBeeb()
    ...
    Private Sub clsVDockAudit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If dt.Rows.Count > 0 Then
            ...
            txtItem.Text = dt.Rows(0)("Varian").ToString
