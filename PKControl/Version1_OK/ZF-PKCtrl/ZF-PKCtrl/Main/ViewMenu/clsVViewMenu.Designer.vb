...
Partial Public Class clsVViewMenu
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnAll.Text = "4. Review - All Status"
        '
        'clsVViewMenu
        '
