...
Public Class clsVSyncronize
    ...
    Private Sub DeviceConnect()
        Do
            ...
            If ChkDeviceConnect = True Then Exit Do
...
ContinueLoop:
    ...
    Private Sub TransToDB()

        txtStatus.Text = "Saving Transaction"
        DataBase.BeginTrans()
        Try
            'Dim files() As String = Directory.GetFiles(INI.InterfaceTrn)
            'Dim SorceFile As String = files(files.Length - 1).ToString
            ...
            Do
                ...
                'ID,ScanType,Rack,Remark,Model,Code,Running,ScanDateTime,From,To,RackDTID,StaffCode
                'ID,ScanType,RackDTID,From,To,StaffCode,ScanDateTime,UpdateUser,UpdateDate,Replaced
                If Lines.Length = 16 Then
                    ...
                    Dim sql As String = ""
                    sql = "update PrgTransaction set Replaced=1 where RackDTID=" & rRackDTID & " and ScanDateTime<'" & rScanDateTime & "' and Replaced=0"
