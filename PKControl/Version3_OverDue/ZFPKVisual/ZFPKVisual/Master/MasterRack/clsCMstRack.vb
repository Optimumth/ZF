...
Public Class clsCMstRack
    Public Function GetData(chkSType As Boolean, iType As Integer _
        ...
        Dim iFront As Integer = SystemINI.ModelType.Front
        Dim iRear As Integer = SystemINI.ModelType.Rear
        Dim iBPS As Integer = SystemINI.ModelType.BPS

        Dim dt As DataTable = DataBase.DataSelect("MstRackHD" _
                                                  , cond _
                                                  , , , "MstRackHD.*" & _
                                                        ",MstModel.Model" & _
        ...
        Dim dtRackDT As DataTable = DataBase.DataSelect("MstRackDT", , , , "distinct RackHeaderID")
