...
#Region "Control Changed"
    Private Sub ControlChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRackColumn.TextChanged, txtAutoMBHrs.TextChanged, txtOutlogPath.TextChanged, txtMBDue.TextChanged, txtCurPassword.TextChanged, txtNewPassword.TextChanged, txtConfirmPassword.TextChanged
...
#Region "Select Document Path"
    Private Sub btnPath_Click(sender As System.Object, e As System.EventArgs) Handles btnOutlogPath.Click
