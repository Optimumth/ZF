...
Public Class clsVChangeStatus
    ...
    Private Sub clsVChangeStatus_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Select Case dr("RackStatus")
            ...
            Case CustomizeSetting.INI.Status_MB : rdoMB.Checked = True
    ...
    Private Sub btnSave_Click(sender As Object, e As OPE_Controls.EventArgs) Handles btnSave.Click
        ...
        If rdoMB.Checked Then NewStatus = CustomizeSetting.INI.Status_MB
        ...
        If mCurStatus <> NewStatus Then
            If Not (mCurStatus = CustomizeSetting.INI.Status_OnTruck And NewStatus = CustomizeSetting.INI.Status_MB) Then
