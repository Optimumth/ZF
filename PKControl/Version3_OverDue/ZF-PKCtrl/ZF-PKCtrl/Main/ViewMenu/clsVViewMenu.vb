...
#Region "Program Active"
    Private Sub clsVViewMenu_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, btnMB.KeyUp, btnSup.KeyUp, btnExtWH.KeyUp, btnAll.KeyUp, btnExit.KeyUp
        ...
        Select Case e.KeyCode
            ...
            Case Keys.D4 : AllStatusClick()
            Case Keys.Escape : ExitClick()
        End Select
    End Sub
    Private Sub clsVViewMenu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Click, btnMB.Click, btnSup.Click, btnExtWH.Click, btnAll.Click, btnExit.Click
        clsCLogin.ActiveDateTime = Now
