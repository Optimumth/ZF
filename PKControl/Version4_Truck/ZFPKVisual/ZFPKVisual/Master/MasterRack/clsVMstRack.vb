...
Public Class clsVMstRack
    ...
    Private iFront As Integer = SystemINI.ModelType.Front
    Private iRear As Integer = SystemINI.ModelType.Rear
...
#Region " Data Grid "
    Private Sub grdData_BindingGridColumns() Handles grdData.BindingGridColumns
        With grdData
            ...
            .ColumnAdd_TextBox("InitialNo", "Initial", "InitialNo")
            .ColumnAdd_TextBox("EndNo", "End", "EndNo")
            ...
            If cboType.SelectedIndex >= 0 And cboModel.SelectedIndex >= 0 And txtInitialNo.Text.Trim <> "" And txtEndNo.Text.Trim <> "" Then
                ...
                Else
                    ...
                    If nIni > 0 And nEnd > 0 And sCode <> "" Then
                        ...
                        dt = DataBase.DataSelect("MstRackHD", "DelFlag=0 and RackHeaderID<>" & mRackHDID & " and ModelID=" & iModel & " and Code='" & sCode & "' and Type=" & iType & " and Remark='" & sRemark & "'")
