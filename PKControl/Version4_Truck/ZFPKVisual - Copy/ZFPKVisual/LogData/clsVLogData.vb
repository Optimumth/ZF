        ...
        Try
            ...
            For Each dr As DataRow In dt.Select()
                If Converts.ToInt_NullIsZero(dr("chk")) = 1 Then
                    ...
                    outFile.WriteLine("Customer,LOG Date,Rack ID.,Model,Rack No.,Show,Remark,Rack Status,Date Scan,Time Scan,Scan User,Date Upload,Time Upload,User Upload, Status, Loss Date, Loss Remark,Truck,ShipDate")
