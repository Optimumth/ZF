...
#Region "Summary"
    Private Sub Summary()
        ...
        txtFront.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelType.Front & " and sta<>'D'")
        txtRear.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelType.Rear & " and sta<>'D'")
        txtBPS.Text = dt.Compute("count(ID)", "Type=" & SystemINI.ModelType.BPS & " and sta<>'D'")
    End Sub
#End Region
