...
#Region "Load"
    ...
    Private Sub LoadForm()
        ...
        Dim dt As DataTable = cls.GetData(True, "-", False, -1, False, -1, False, "", False, 0)
        Dim dv As DataView
...
#Region "Toolbar Click"
    Private Sub btnSearch_Click(sender As Object, e As OPE_Controls.EventArgs) Handles btnSearch.Click
        ...
        End If
        Dim dt As DataTable = cls.GetData(chkSVariant.Checked, sVariant, chkSAreaCode.Checked, AreaID, chkSPartType.Checked, PartTypeID, chkSPartNo.Checked, PartNo, chkSCaliper.Checked, iCaliperFlag)
        Dim dv As DataView
        dv = New DataView(dt, "sta<>'D'", "", DataViewRowState.CurrentRows)
        grdData.DataSource = dv
