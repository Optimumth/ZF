...
#Region " Data Grid "
    Private Sub grdData_BindingGridColumns() Handles grdData.BindingGridColumns
        With grdData
            ...
            .ColumnAdd_TextBox("ModelContainer", "Model Group", "ModelContainer", 500)
    ...
    Private Function OKValidate() As Boolean
        ...
        Else
            If fNew Then
                ...
                Else
                    Dim dtModel As DataTable = DataBase.DataSelect("MstModel", "DelFlag = 0 and Model='" & txtModel.Text.Trim & "'")
