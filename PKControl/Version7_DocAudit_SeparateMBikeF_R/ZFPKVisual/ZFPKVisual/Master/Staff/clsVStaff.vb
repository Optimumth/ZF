...
Public Class clsVStaff
    ...
    Private iDeviceType As Integer
    ...
    Public Sub ShowForm(ByVal View As Integer, ByVal Add As Integer, ByVal Up As Integer, ByVal Del As Integer, ByVal Print As Integer, ByVal Other1 As Integer, ByVal Other2 As Integer, ByVal Other3 As Integer)
        ...
        iDeviceType = eDeviceType.Android

        If CustomerCode = "MB" Then
            btnHandy.Visible = True
        Else
            btnHandy.Visible = False
        End If
...
#Region " Search "
    ...
    Private Sub chkSStaffId_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSStaffId.CheckedChanged
        If Not chkSStaffId.Checked Then
            txtStaffId.Text = ""
        End If
    End Sub

    Private Sub chkSSurName_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSSurName.CheckedChanged
        If Not chkSSurName.Checked Then
            txtSSurName.Text = ""
        End If
    End Sub

    Private Sub chkSNickName_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSNickName.CheckedChanged
        If Not chkSNickName.Checked Then
            txtSNickName.Text = ""
        End If
    End Sub

    Private Sub chkSLoginId_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSLoginId.CheckedChanged
        If Not chkSLoginId.Checked Then
            txtSLoginId.Text = ""
        End If
    End Sub

    Private Sub chkSGivenName_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSGivenName.CheckedChanged
        If Not chkSGivenName.Checked Then
            txtSGivenName.Text = ""
        End If
    End Sub

    Private Sub chkSUserGroupId_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSUserGroupId.CheckedChanged
...
#Region "Transfer Master File to handy"
    Private Sub btnHandy_Click(sender As System.Object, e As System.EventArgs) Handles btnHandy.Click
        Do
    ...
    Private Function DeviceConnect() As Boolean
        ...
        If iDeviceType = eDeviceType.WinCE Then
            ...
            bTrue = OBSWMC.Connect()
        Else
            'Android
            bTrue = ADBCheckAndroidPath()
        End If
    ...
    Private Function SendMasterFile() As Boolean
        ...
        If iDeviceType = eDeviceType.WinCE Then
            ...
            bTrue = String.IsNullOrEmpty(OBSWMC.Err)
        Else
            Dim SlashForPC As String = "\"
            Dim SlashForHandy As String = "/"

            Dim PCPath As String = INI.InterfaceStaff & INI.StaffFilename
            Dim HandyFile As String = INI.HandyInterface & "/Staff" & Replace(INI.StaffFilename, SlashForPC, SlashForHandy)
            bTrue = ADBPushToAndroid(PCPath, HandyFile)
        End If
    ...
    Private Function ADBCheckAndroidPath() As Boolean
        ...
        Dim devicePath As String = INI.HandyInterface    ' --> /storage/emulated/0/Android/data/zf.bmw.pkctrl_bmw/files/
...
#End Region
    ...
    Private Sub clsVStaff_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
