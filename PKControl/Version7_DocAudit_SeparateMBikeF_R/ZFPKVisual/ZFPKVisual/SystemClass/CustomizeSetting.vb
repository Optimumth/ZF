...
Public Class CustomizeSetting
    ...
    Public Shared CustomerCode As String = "" 'MB, BMW
    ...
    Public Shared Sub RunSetting()
        ...
        Dim InfoPathCus As String = Info.ProjectPath & "\" & CustomerCode
        Dim rPath As DataRow = DataBase.DataRow("MstSystemConfig")
        With INI
            .QtyDigit = 0
            .ReportTemplatePath = InfoPathCus & "\ReportTemplate"
            .ReportOutputPath = InfoPathCus & "\ReportOutput"
            .PicturePath = InfoPathCus & "\Picture"
            .InterfaceMst = InfoPathCus & "\Interface\Mst"
            .InterfaceTrn = InfoPathCus & "\Interface\Trans"
            .InterfaceStaff = InfoPathCus & "\Interface\Staff"
            .InterfaceDockAudit = InfoPathCus & "\Interface\DockAudit"
            .RackColumn = rPath("RackColumn")
            .AutoMBHr = rPath("AutoMBHR")
            .OutLogPath = rPath("OutlogFile")
            .ReportOutputPath = rPath("ReportPath")
            .RackStatusPassword = rPath("AuthorRackStatus")
            If CustomerCode <> "MB" Then
                .OutLogDockAudit = rPath("OutlogDockAudit")
                .AuthorRemove = rPath("AuthorRemove")
            End If
        End With
        With Styles
...
Public Class CustomizeINI
    ...
    Public sFrontRear As String = "Front & Rear"
    Public sBPS As String = "BPS"
    Public sSTB As String = "STB"
    Public sMBikeFront As String = "M-Bike Front"
    Public sMBikeRear As String = "M-Bike Rear"
    Public sPTC As String = "Protective caliper"
    ...
    Public Status_FG As String = "FG"
    Public Status_RepairInZF As String = "Repair in ZF"
    ...
    Public InterfaceDockAudit As String = ""
    Public MstFilename As String = ""
    Public StaffFilename As String = ""
    Public HandyInterface As String = ""
    '============================
    Public DockAuditMstItemFileName As String = ""
    Public DockAuditMstModelDockFileName As String = ""
    Public DockAuditMstPartFileName As String = ""
    Public DockAuditMstStaffFileName As String = ""
    Public DockAuditMstQCFileName As String = ""
    Public DockAuditInterface As String = ""
    '=============================
    Public OutLogPath As String = ""
    Public OutLogDockAudit As String = ""
    Public RackStatusPassword As String = ""
    Public EnableSync As Boolean = False
    Public AuthorRemove As String = ""
    '=======================================
End Class
