...
#Region "Program Active"
    Private Sub clsVView_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, btnExit.KeyUp, btnDeleteRack.KeyUp, btnDeleteTruck.KeyUp, btnSortA.KeyUp, btnSortD.KeyUp, grdData.KeyUp, txtRackQty.KeyUp, txtTruckQty.KeyUp, txtPTCQty.KeyUp
...
#End Region
    ...
    Private Sub ShowGrid()
        ...
        dtShowGrid.Columns.Add("IsPTC", GetType(Integer))
        ...
        Dim cRack As Integer = 0
        Dim cPTC As Integer = 0
        For Each drShowGrid As DataRow In dtShowGrid.Select()
            If drShowGrid("IsPTC") = 1 Then
                cPTC = cPTC + 1
            Else
                cRack = cRack + 1
            End If
        Next
        txtRackQty.Text = cRack
        txtPTCQty.Text = cPTC
