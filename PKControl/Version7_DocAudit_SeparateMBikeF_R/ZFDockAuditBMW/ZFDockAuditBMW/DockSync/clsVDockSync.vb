...
Public Class clsVDockSync
    Private InterfacePath As String = ""
    Private TransOK As Boolean = False

#Region "Program Active"

    Private Sub clsVDockSync_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ...
        Next
    End Sub
    Private Sub clsVDockSync_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, btnExit.KeyUp
        ...
        End Select
    End Sub
    Private Sub clsVDockSync_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Click, btnExit.Click
        clsCLogin.ActiveDateTime = Now
...
#End Region
    ...
    Private Sub clsVDockSync_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lblZF.Text = ""
        lblBMW.Text = ""
        lblOntruck.Text = ""
        lblSuplier.Text = ""
